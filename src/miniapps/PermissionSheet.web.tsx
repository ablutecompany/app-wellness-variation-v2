/**
 * PermissionSheet.web.tsx — web platform override
 *
 * On Expo Web, React Native's <Modal> renders into a portal but can have
 * stacking/z-index issues that make it invisible. This override uses a plain
 * absolutely-positioned overlay instead, which is reliable in the browser.
 */
...
export const PermissionSheet: React.FC<PermissionSheetProps> = ({
  ...
  return (
    // Full-screen fixed overlay — works reliably on web
      ...
      <View style={styles.sheet}>
        ...
        >
          ...
          <Typography style={styles.trustNote}>
            As tuas informações são partilhadas de forma encriptada apenas com
            esta aplicação certificada pela ablute_. Podes revogar o acesso a
            qualquer momento nas definições do perfil.
          </Typography>
...
const styles = StyleSheet.create({
  ...
  iconEmoji: { fontSize: 28, fontWeight: '800' },
  appMeta: { flex: 1 },
  appName: {
    color: '#ffffff',
    fontSize: 20,
  ...
  acceptBtn: { borderRadius: 16, overflow: 'hidden', marginBottom: 12 },
  acceptGradient: { paddingVertical: 16, alignItems: 'center' },
  acceptText: {
    color: '#ffffff',
    fontSize: 16,
    fontWeight: '700',
